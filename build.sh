...
LIBS="$LIBREALSENSE_BASE/build/librealsense2.so $LIBREALSENSE_BASE/build/third-party/glfw/src/libglfw3.a /usr/local/lib/libglut.a -lGL -lGLU -lrt -ldl -lm -lX11 -lXrandr -lXxf86vm -lXi"
OBJS="DepthViewer.cpp.o DVWindow.cpp.o Application.cpp.o Window.cpp.o RealFusion.cpp.o IMUFusion.cpp.o LinearAlgebra.cpp.o Exception.cpp.o FusionAhrs.c.o FusionBias.c.o FusionCompass.c.o vecadd.cu.o"
...
$CXX_COMPILER $DEFINES $INCLUDES $CXX_FLAGS -o DepthViewer.cpp.o -c DepthViewer.cpp
$CXX_COMPILER $DEFINES $INCLUDES $CXX_FLAGS -o DVWindow.cpp.o -c DVWindow.cpp
$CXX_COMPILER $DEFINES $INCLUDES $CXX_FLAGS -o Application.cpp.o -c Application.cpp
$CXX_COMPILER $DEFINES $INCLUDES $CXX_FLAGS -o Window.cpp.o -c Window.cpp
...
$CUDA_COMPILER $CUDA_FLAGS main.cpp.o $OBJS -o DepthViewer $LIBS
